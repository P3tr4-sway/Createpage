...
function SheetContent({
  ...
  const inWorkbenchContainer = Boolean(container);
  const transformOriginBySide: Record<NonNullable<typeof side>, string> = {
    top: "top center",
    right: "top right",
  ...
  return (
    <SheetPortal container={container}>
      <div
        style={{
          position: inWorkbenchContainer ? "absolute" : "fixed",
          inset: 0,
          width: "100%",
          height: "100%",
      ...
      >
        <SheetOverlay className={inWorkbenchContainer ? "absolute inset-0" : undefined} />
        <SheetPrimitive.Content
          ...
          className={cn(
            ...
            inWorkbenchContainer ? "absolute" : "fixed",
            side === "right" &&
